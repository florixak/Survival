package cz.florixak.survival.inventory.inventories;


import cz.florixak.survival.Survival;
import cz.florixak.survival.inventory.AbstractInventory;
import cz.florixak.survival.inventory.InventoryBuilder;
import cz.florixak.survival.inventory.InventoryItem;
import cz.florixak.survival.utility.ItemStackBuilder;
...
public class CustomGUI extends AbstractInventory {
    ...
    public CustomGUI(Survival plugin, FileConfiguration config) {
        super(plugin);
        this.config = config;
    }
